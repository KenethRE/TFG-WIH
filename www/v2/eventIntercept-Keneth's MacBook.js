...
function socketSetup() {
            ...
            if (targetElement) {
                targetElement.addEventListener(element.eventType, (event) => {
                    if (event.isTrusted) {
                        ...
                        deviceId: MY_WS_ID,
                        userId: USER_ID,
                        eventDetail: event, // Capture event detail if available
                        timestamp: Date.now()
                    });
    ...
    socket.on('receive_event', (data) => {
        if (data.socketid !== MY_WS_ID) {
            ...
            if (element) {
                console.log(`Triggering server event: ${data.eventDetail} on element with ID ${data.elementId}`);
                if (data.eventDetail === 'click') {
                    element.click(); // Simulate click event
                } else if (data.eventDetail === 'input') {
                ...
                } else if (data.eventDetail === 'change') {
                    element.dispatchEvent(new Event('change', {
                        bubbles: true,
                        cancelable: true,
                        composed: true
                    }));
                } else if (data.eventDetail === 'submit') {
                    element.dispatchEvent(new Event('submit', {
                        bubbles: true,
                        cancelable: true,
                        composed: true
                    }));
                } else if (data.eventDetail === 'focus') {
                    element.dispatchEvent(new Event('focus', {
                        bubbles: true,
                        cancelable: true,
                        composed: true
                    }));
                } else if (data.eventDetail === 'blur') {
                    element.dispatchEvent(new Event('blur', {
                        bubbles: true,
                        cancelable: true,
                        composed: true
                    }));
                } else if (data.eventDetail === 'keydown') {
                ...
                } else if (data.eventDetail === 'keyup') {
                ...
                } else if (data.eventDetail === 'keypress') {
                ...
                } else if (data.eventDetail === 'mouseover') {
                ...
                } else if (data.eventDetail === 'mouseout') {
                ...
                } else if (data.eventDetail === 'mousemove') {
                ...
                } else if (data.eventDetail === 'touchstart') {
                ...
                } else if (data.eventDetail === 'touchend') {
                ...
                } else if (data.eventDetail === 'touchmove') {
                ...
                } else if (data.eventDetail === 'contextmenu') {
                ...
                } else if (data.eventDetail === 'dblclick') {
                ...
                } else if (data.eventDetail === 'wheel') {
                ...
                } else if (data.eventDetail === 'scroll') {
                    ...
                    console.warn(`Unknown event type: ${data.eventDetail}. Dispatching generic event.`);
                    }
                }
